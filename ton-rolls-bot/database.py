...
def _migrate_new_tables() -> None:
    ...
    with _conn() as db:
        ...
        try: db.execute("ALTER TABLE bonuses ADD COLUMN boost_count INTEGER DEFAULT 1")
        except: pass
        try: db.execute("ALTER TABLE bonuses ADD COLUMN repeat_hours INTEGER DEFAULT 0")
        except: pass
