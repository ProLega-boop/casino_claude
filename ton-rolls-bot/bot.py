...
from aiogram.types import (Message, InlineKeyboardMarkup, InlineKeyboardButton,
                           ...
                           BotCommandScopeAllGroupChats, ChatMemberAdministrator,
                           ChatMemberOwner)
import config
...
# Cache bot id so we don't call get_me() on every /me in groups
...
async def setup_commands() -> None:
    ...
    group_cmds = [
        BotCommand(command="me", description="📊 Профиль и статистика игрока"),
    ]
...
async def cmd_me(message: Message):
    ...
    # ── Group chats: only reply if bot is an admin ──
    ...
    if message.chat.type == "private":
        ...
        # In groups: just text, no inline keyboard
